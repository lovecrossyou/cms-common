...
CREATE TABLE `user` (
  ...
  `update_time` TIMESTAMP(6) NULL  COMMENT '最后登录时间',
...
CREATE TABLE `upload` (
  ...
  `create_time` TIMESTAMP(6) NULL COMMENT '上传时间',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`) USING BTREE
...
CREATE TABLE `media` (
  ...
  `create_time` TIMESTAMP(6) NULL COMMENT '添加时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `comment` (
  ...
  `create_time` TIMESTAMP(6) NULL COMMENT '评论时间',
  PRIMARY KEY (`id`),
  KEY `article_id` (`article_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
